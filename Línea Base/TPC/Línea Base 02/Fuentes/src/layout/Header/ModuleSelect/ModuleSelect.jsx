...
import { Group, Stack, UnstyledButton, Menu, Text, rem } from "@mantine/core";
  ...
  return (
    ...
    >
      <Menu.Target>
        ...
        >
          <Group className={classes.control} p={10} gap={10} justify="center">
            <currentModuleProps.Icon size={17} />
            <Text size={rem(14)} className={classes.label}>
              {currentModuleProps.label}
            </Text>
